...
if [ $paired = "y" ]
then
  $tooldir/discover/scripts/duk/duk -m filteredO1.fq -k 23 $tooldir/discover/data/HO/O_type.fsa $fastqfile1;
  $tooldir/discover/scripts/duk/duk -m filteredH1.fq -k 23 $tooldir/discover/data/HO/H_type.fsa $fastqfile1;
  cat filteredO1.fq > filteredOH1.fq;
  cat filteredH1.fq >> filteredOH1.fq;
  $tooldir/discover/scripts/duk/duk -m filteredO2.fq -k 23 $tooldir/discover/data/HO/O_type.fsa $fastqfile2;
  $tooldir/discover/scripts/duk/duk -m filteredH2.fq -k 23 $tooldir/discover/data/HO/H_type.fsa $fastqfile2;
  ...
  then
    ...
    rm -r output_dir;
    blastn -query duk_spades.fasta -db $tooldir/discover/data/HO/O_type -task blastn -evalue 0.001 -out duk_O_seqs -outfmt '6 std sallseqid score nident positive gaps ppos qframe sframe qseq sseq qlen slen salltitles' -num_threads 8 -strand both -dust yes -max_target_seqs 10 -perc_identity 95.0;
    blastn -query duk_spades.fasta -db $tooldir/discover/data/HO/H_type -task blastn -evalue 0.001 -out duk_H_seqs -outfmt '6 std sallseqid score nident positive gaps ppos qframe sframe qseq sseq qlen slen salltitles' -num_threads 8 -strand both -dust yes -max_target_seqs 10 -perc_identity 95.0;
  else
    touch duk_O_seqs;
    touch duk_H_seqs;
  fi
...
# BLAST FASTA
blastn -query $fastafile -db $tooldir/discover/data/HO/O_type -task blastn -evalue 0.001 -out fasta_O_seqs -outfmt '6 std sallseqid score nident positive gaps ppos qframe sframe qseq sseq qlen slen salltitles' -num_threads 8 -strand both -dust yes -max_target_seqs 10 -perc_identity 95.0;
blastn -query $fastafile -db $tooldir/discover/data/HO/H_type -task blastn -evalue 0.001 -out fasta_H_seqs -outfmt '6 std sallseqid score nident positive gaps ppos qframe sframe qseq sseq qlen slen salltitles' -num_threads 8 -strand both -dust yes -max_target_seqs 10 -perc_identity 95.0;
